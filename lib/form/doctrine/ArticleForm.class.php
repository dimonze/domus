 ...
 */
class ArticleForm extends PostForm
{
  public function configure() {
    ...
    $this->widgetSchema['post_text']->setLabel('Текст статьи');
    $this->widgetSchema['lid']->setLabel('Лид');    
    $this->widgetSchema->setHelp('on_main', 'Поместить статью на главную страницу');       
    ...
    if (!sfContext::getInstance()->getUser()->hasCredential('redactor-article-actions')){
