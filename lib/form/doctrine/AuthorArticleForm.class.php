 ...
 */
class AuthorArticleForm extends PostForm
{
  public function configure()
  {    
    $this->setWidgets(array(
      'title' => new sfWidgetFormInputText(),
      'region_list' => new sfWidgetFormDoctrineChoice(
        array(
          'model' => 'Region',
          'expanded' => true,
      ...
      'author_id'    => new sfWidgetFormDoctrineChoice(array('model' => 'PostAuthor', 'table_method' => 'getAuthors', 'add_empty' => true)),
    ...
    if (!sfContext::getInstance()->getUser()->hasCredential('author-blog-actions')){
  ...
  protected function doSave($con = null) {
    ...
    $values['post_type']  = 'author_article';
