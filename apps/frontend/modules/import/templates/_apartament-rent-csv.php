<h3>Инструкция по формированию файла CSV для аренды квартир</h3>

<div class="ad-format">
  <a class="get-example top" href="/uploads/import/apartament-rent.csv" target="_blank">Скачать пример</a>
  <table>
    <thead>
      <tr>
        <th>Название</th>        
  ...
  <a class="get-example bottom" href="/uploads/import/apartament-rent.csv" target="_blank">Скачать пример</a>
</div>