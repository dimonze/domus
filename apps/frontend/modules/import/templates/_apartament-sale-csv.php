<h3>Инструкция по формированию файла CSV для продажи квартир</h3>

<div class="ad-format">
  <a class="get-example top" href="/uploads/import/apartament-sale.csv" target="_blank">Скачать пример</a>
  <table>
    <thead>
      <tr>
        <th>Название</th>        
