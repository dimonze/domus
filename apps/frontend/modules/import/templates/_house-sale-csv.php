<h3>Инструкция по формированию файла CSV для продажи домов и участков</h3>

<div class="ad-format">
  <a class="get-example top" href="/uploads/import/house-sale.csv" target="_blank">Скачать пример</a>
  <table>
    <thead>
      <tr>
        <th>Название</th>        
  ...
  <a class="get-example bottom" href="/uploads/import/apartament-sale.csv" target="_blank">Скачать пример</a>
</div>