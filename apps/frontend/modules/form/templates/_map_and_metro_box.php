<legend>
    <a href="#" class="map-switch<?= (empty($stage) || $stage == 'map-popup-metro' ? ' selected' : '') ?>" rel="metrocol">Метро</a>
    <a href="#" class="map-switch<?= ($stage == 'map-popup-region' ? ' selected' : '') ?>" rel="regioncol">Округа, районы и поселки</a>
...
<div class="popupCenter" binded="true">
    <div class="body">
      <fieldset>        
        <table<?php if($sf_request->getCookie('current_region') != 77):?> style="width: 100%;"<? endif; ?>>
          <tbody>
          <tr>
            <?php if($sf_request->getCookie('current_region') == 77): ?><td>
              <table>
                <tr>
                  <td>
                    <div class="regionmap-box">
                      <div class="regions-selected">
                        <div class="selected-list-box">
                          <div class="metro">
                            <h4>Выбранные метро:</h4>
                          </div>
                          <div class="regions">
                            <h4>Округа:</h4>
                          </div>
                        ...
                        <div class="showhide">
                          <a href="#"><span>Показать все <ins></ins></span><span class="opened">Скрыть</span><var></var></a>
                        </div>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  <td class="metrocol" style="display:<?= (empty($stage) || $stage == 'map-popup-metro' ? ' table-cell' : 'none') ?>">
                    <div class="sub-wrap">
                      <div id="metromap-pop">
                        <?= image_tag_s('metro-map-rus1.gif', 'width=607 height=804 usemap=#metroMap id=metroimage') ?>
                        ...
                        <div id="pp33" class="pp" style="display: none;" onclick="metro.checkStation(33); return false;">
                          <span class="pp"></span></div>
                        <div id="pp32" class="pp" style="display: none;" onclick="metro.checkStation(32); return false;">
                          <span class="pp"></span></div>
                        <div id="pp31" class="pp" style="display: none;" onclick="metro.checkStation(31); return false;"></div>
                        <div id="pp30" class="pp pp-b" style="display: none;" onclick="metro.checkStation(30); return false;">
                          <span class="pp"></span></div>
                        ...
                        <div id="pp10" class="pp" style="display: none;" onclick="metro.checkStation(10); return false;">
                          <span class="pp"></span></div>
                        ...
                        <div id="pp52" class="pp pp-b" style="display: none;" onclick="metro.checkStation(52); return false;">
                          <span class="pp"></span></div>
                        ...
                        <div id="pp133" class="pp" style="display: none;" onclick="metro.checkStation(133); return false;">
                          <span class="pp"></span></div>
                        ...
                        <div id="pp103" class="pp" style="display: none;" onclick="metro.checkStation(103); return false;">
                          <span class="pp"></span></div>
                        ...
                        <!--  Underkonstruction<div id="pp165" class="pp" style="display: none;"  onclick="metro.checkStation(165); return false;" ></div>--><!-- Kalininskaya YELLOW --><!--  Underkonstruction <div id="pp173" class="pp" style="display: none;"  onclick="metro.checkStation(173); return false;" ></div> -->
                        ...
                        <div id="pp88" class="pp" style="display: none;" onclick="metro.checkStation(88); return false;">
                          <span class="pp"></span></div>
                        ...
                        <div id="pp172" class="pp" style="display: none;" onclick="metro.checkStation(172); return false;">
                          <span class="pp"></span></div>
                        <!-- Lublinskaya LIGHT GREEN   --><!--  Underkonstruction<div id="pp177" class="pp" style="display: none;"  onclick="metro.checkStation(177); return false;" ></div><div id="pp176" class="pp" style="display: none;"  onclick="metro.checkStation(176); return false;" ></div><div id="pp246" class="pp" style="display: none;"  onclick="metro.checkStation(246); return false;" ></div>-->
                        ...
                        <div id="pp2007" class="pp" style="display: none;">
                          <span class="pp"></span></div>
                        ...
                        <div id="pp2010" class="pp" style="display: none;">
                          <span class="pp"></span></div>
                        ...
                        <map name="metroMap" id="metroMap">
                          <!--  <area  shape="rect" coords="098, 642, 110, 654" onclick="metro.checkStation(194); return false;" title="Боровское шоссе" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="098, 595, 110, 607" onclick="metro.checkStation(191); return false;" title="Вострякова" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="345, 134, 357, 146" onclick="metro.checkStation(187); return false;" title="Выставочный центр" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="098, 564, 110, 576" onclick="metro.checkStation(189); return false;" title="Никулинская" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="098, 658, 110, 670" onclick="metro.checkStation(195); return false;" title="Новопеределкино" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="098, 579, 110, 591" onclick="metro.checkStation(190); return false;" title="Олимпийская деревня" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="098, 626, 110, 638" onclick="metro.checkStation(193); return false;" title="Солнцево" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="269, 135, 281, 147" onclick="metro.checkStation(183); return false;" title="Тимиирязевская (лм)" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="098, 611, 110, 623" onclick="metro.checkStation(192); return false;" title="Терешково" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="305, 134, 317, 146" onclick="metro.checkStation(185); return false;" title="Телецентр" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="098, 545, 110, 557" onclick="metro.checkStation(196); return false;" title="Юго-Западная (лм)" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="324, 134, 336, 146" onclick="metro.checkStation(186); return false;" title="улица Академика Королева" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="288, 134, 300, 146" onclick="metro.checkStation(184); return false;" title="улица Милашенкова" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="311, 670, 323, 682" onclick="metro.checkStation(179); return false;" title="улица Скобелевская" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="365, 134, 377, 146" onclick="metro.checkStation(188); return false;" title="улица Эзенштейна" href="javascript: void(0);" alt="" />  -->  <!-- Sokol'nicheskaya red -->
                          ...
                          <area shape="rect" coords="240, 359, 346, 367" onclick="metro.checkStation(30); return false;" title="Библиотека им. Ленина" href="javascript: void(0);" alt="">
                          ...
                          <area shape="rect" coords="127, 342, 187, 350" onclick="metro.checkStation(160); return false;" title="Смоленская" href="javascript: void(0);" alt="">
                          <area shape="rect" coords="188, 369, 243, 376" onclick="metro.checkStation(159); return false;" title="Арбатская" href="javascript: void(0);" alt="">
                          ...
                          <area shape="rect" coords="197, 328, 258, 336" onclick="metro.checkStation(161); return false;" title="Смоленская(Филевская)" href="javascript: void(0);" alt="">
                          <area shape="rect" coords="212, 343, 267, 351" onclick="metro.checkStation(158); return false;" title="Арбатская(Филевская)" href="javascript: void(0);" alt="">
                          ...
                          <area shape="rect" coords="495, 555, 589, 565" onclick="metro.checkStation(77); return false;" title="Волгоградский Пр-т" href="javascript: void(0);" alt="">
                          ...
                          <area shape="rect" coords="495, 595, 595, 605" onclick="metro.checkStation(80); return false;" title="Рязанский Пр-т" href="javascript: void(0);" alt="">
                          ...
                          <!--  Underkonstruction  <area  shape="rect" coords="495, 625, 550, 632" onclick="metro.checkStation(165); return false;" title="Pronskaya" href="javascript: void(0);" alt="" />  -->  <!-- Kalininskaya YELLOW -->  <!--  Underkonstruction  <area  shape="rect" coords="515, 209, 573, 217" onclick="metro.checkStation(173); return false;" title="Novokosino" href="javascript: void(0);" alt="" />  -->
                          ...
                          <area shape="rect" coords="221, 527, 304, 539" onclick="metro.checkStation(126); return false;" title="Нахимовский пр-т" href="javascript: void(0);" alt="">
                          ...
                          <!-- Lublinskaya light green  -->  <!--  Underkonstruction  <area  shape="rect" coords="322, 139, 403, 146" onclick="metro.checkStation(177); return false;" title="Maryina roshcha" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="320, 159, 398, 170" onclick="metro.checkStation(176); return false;" title="Dostoyevskaya" href="javascript: void(0);" alt="" />  <area  shape="rect" coords="321, 172, 422, 181" onclick="metro.checkStation(197); return false;" title="Ploshcad Suvorova" href="javascript: void(0);" alt="" />  -->
                          ...
                          <!-- All stations on the line   <area alt="" href="javascript: void(0);" title="Сокольническая" onclick="metro.checkLine(this); " coords="037, 763, 118, 769" id="m1" shape="rect">  <area alt="" href="javascript: void(0);" title="Замоскворецкая" onclick="metro.checkLine(this); " coords="037, 773, 126, 781" id="m2" shape="rect">  <area alt="" href="javascript: void(0);" title="Арбатско-покровская" onclick="metro.checkLine(this); " coords="037, 783, 145, 791" id="m3" shape="rect">  <area alt="" href="javascript: void(0);" title="Арбатско-покровская" onclick="metro.checkLine(this); " coords="037, 783, 145, 791" id="m3" shape="rect">  <area alt="" href="javascript: void(0);" title="Филевская" onclick="metro.checkLine(this); " coords="037, 795, 093, 802" id="m4" shape="rect">  <area alt="" href="javascript: void(0);" title="Кольцевая" onclick="metro.checkLine(this); " coords="148, 762, 209, 770" id="m5" shape="rect">  <area alt="" href="javascript: void(0);" title="Калужско-рижская" onclick="metro.checkLine(this); " coords="149, 772, 248, 781" id="m6" shape="rect">  <area alt="" href="javascript: void(0);" title="Таганско-краснопресненская" onclick="metro.checkLine(this); " coords="149, 784, 289, 792" id="m7" shape="rect">  <area alt="" href="javascript: void(0);" title="Калининская" onclick="metro.checkLine(this); " coords="148, 795, 213, 803" id="m8" shape="rect">  <area alt="" href="javascript: void(0);" title="Серпуховско-тимирязевская" onclick="metro.checkLine(this); " coords="293, 762, 434, 770" id="m9" shape="rect">  <area alt="" href="javascript: void(0);" title="Люблинская" onclick="metro.checkLine(this); " coords="293, 773, 358, 780" id="m10" shape="rect">  <area alt="" href="javascript: void(0);" title="Каховская" onclick="metro.checkLine(this); " coords="292, 785, 358, 792" id="m11" shape="rect">  <area alt="" href="javascript: void(0);" title="Бутовская" onclick="metro.checkLine(this); " coords="293, 796, 353, 802" id="m12" shape="rect">-->
                        </map>
                        <input type="hidden" id="stations" name="stations" value="">
                      </div>
                    </div>
                  </td>
                  <td class="regioncol" style="display:<?= ($stage == 'map-popup-region' ? ' table-cell' : 'none') ?>">
                    <div class="regionmap-box">
            ...
            <td>
              <table<?php if($sf_request->getCookie('current_region') != 77):?> style="width: 100%;"<? endif; ?>>
                 <?php if($sf_request->getCookie('current_region') == 77): ?><tr>
                  <td>
                    <div class="button-links">
                      <span class="formButton"><input type="submit" value="Применить"></span>
                      <a class="popupReset" href="#">Очистить</a>
                      <a class="popupClose" href="#">Отменить</a>
                    </div>
                  </td>
                </tr><?php endif; ?>
                <tr>
                  <td class="metrocol" style="display:<?= (empty($stage) || $stage == 'map-popup-metro' ? ' table-cell' : 'none') ?><?php if($sf_request->getCookie('current_region') != 77):?>;padding-top: 25px !important; padding: 15px 15px 0 22px;<? endif; ?>">
                    <ul id="metro-list" class="regionnode-list">
                      <?php foreach ($nodes as $key=>$node): ?>
                        <?php $node_text = Regionnode::formatName($node->name, $node->socr)?>
                        <?php if ($node->getIsMetro()): ?>
                        <li>
                          <label>
                            <input type="checkbox" id="metro_<?= $key ?>" value="<?= $node_text ?>" /><?= $node_text ?>
                          </label>
                        </li>
                        <?php endif ?>
                      <?php endforeach ?>
                  ...
                  <td class="regioncol<?php echo $sf_request->getCookie('current_region') != 77 ? ' rayonlist' : '' ?>" style="display:<?= ($stage == 'map-popup-region' ? ' table-cell' : 'none') ?><?php if($sf_request->getCookie('current_region') != 77): ?>;padding: 0 15px 0 22px;<? endif; ?>">
                    <div class="district-scroller">
                      <?php if($sf_request->getCookie('current_region') == 77): ?><h2>Выберите необходимые округа</h2>
                      <ul class="regions">
                        <?php $i=0; foreach ($nodes as $node): ?>
                          <?php if ($node->socr == ''): ?>
                            ...
                            <li>
                              <label>
                                <input type="checkbox" value="<?= $node_text ?>" id="region_<?= $i ?>" /><?= $node_text ?>
                              </label>
                            </li>
                            <?php $i++ ?>
                          <?php endif ?>
                      ...
                      <h2>Выберите необходимые районы</h2><?php endif ?>
                      <ul class="districts regionnode-list">
                        <?php $i=0; foreach ($nodes as $node):
                            $pattern = 'район|пос|го' . ( $sf_request->getCookie('current_region') != 77 ? '|г' : '' );
                            if (preg_match('#^('.$pattern.')#', $node->socr)):
                              $node_text = Regionnode::formatName($node->name, $node->socr)?>
                            <li>
                              <label for="distr_<?= $i ?>">
                                <input id="distr_<?= $i ?>" region="<?= $node->Regionnode->name ?>" type="checkbox" value="<?= $node_text ?>" /><?= $node_text ?>
                              </label>
                            </li>
                            <?php $i++ ?>
                          <?php endif ?>
          ...
          <tfoot>
          <tr>
             <?php if($sf_request->getCookie('current_region') == 77): ?><td></td><?php endif; ?>
            <td>
              <div class="button-links">
                <span class="formButton"><input type="submit" value="Применить"></span>
                <?php if($sf_request->getCookie('current_region') == 77): ?><a class="popupReset" href="#">Очистить</a><?php endif; ?>
                <a class="popupClose" href="#">Отменить</a>
              </div>
            </td>
          </tr>
