<div class="rc-box news themes authors-blue blue-box">
  ...
  <div class="content">
    <div class="col-left">
      <h2><span class="png24"></span>Авторы</h2>
        ...
        <ul>
          <?php foreach ($authors as $author): ?>
            <?php if ($current_author_id == $author->id): ?>
              <li><strong><?= link_to($author->name, '@author_article_show_author?author_id=' . $author->id)?></strong></li>
            <?php else: ?>
              <li><?= link_to($author->name, '@author_article_show_author?author_id=' . $author->id)?></li>
            <?php endif ?>
          <?php endforeach ?>
        </ul>
      <?php endif ?>
