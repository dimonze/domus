<?php include_partial('form/price-box', array('name' => 'Цена м<sup>2</sup>')) ?>

<div class="squareBox">
  <h3>Площадь помещения, м<sup>2</sup></h3>
  <?php include_partial('form/configured-select', array('type' => 'commercial-rent', 'id' => 'field46_from', 'attr' => 'class=select_02')) ?>
  -
  <?php include_partial('form/configured-select', array('type' => 'commercial-rent', 'id' => 'field46_to', 'attr' => 'class=select_02')) ?>
...
<div class="squareBox">
  ...
  <?php include_partial('form/configured-select', array('type' => 'commercial-rent', 'id' => 'field47_from', 'attr' => 'class=select_02')) ?>
  -
  <?php include_partial('form/configured-select', array('type' => 'commercial-rent', 'id' => 'field47_to', 'attr' => 'class=select_02')) ?>
  <a href="#" class="link2 set-custom">Изменить значения</a>
</div>
